...
const generateHTML = pokemons => pokemons.reduce((accumulator, { types, id, name }) => { 
	const elementTypes = types.map(typeInfo => typeInfo.type.name)
	accumulator += 
		`
		<li class="card ${elementTypes[0]}">
			<img class="card-img" src="https://pokeres.bastionbot.org/images/pokemon/${id}.png" alt="${name}">
